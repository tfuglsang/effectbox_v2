...
/**
* @brief Handles Joystick Center (Selection)
*/
...
/**
* @brief Handles Joystick Right and Up
* (These two share a single interrupt vector)
*/
void EXTI9_5_IRQHandler(void)
{
  BSP_JOY_IRQHandler(JOY1, JOY_RIGHT);
  BSP_JOY_IRQHandler(JOY1, JOY_UP);
  // Manually clear the pending bits for the Up/Right pins
...
/**
  * @brief Handles the Blue Wakeup Push Button
  */
